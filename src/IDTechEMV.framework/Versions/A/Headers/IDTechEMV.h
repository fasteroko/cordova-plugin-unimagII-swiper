...
typedef enum{
    ...
    EMV_RC_ERROR_CARD_COMPLETION = 0X24
} EMV_RC_Types;
...
/**
 ...
 Used as parameter in   IDTechEMV::setTerminalData:()
 
 Used as return value in    IDTechEMV::setTerminalData:()
 */
typedef struct {
 ...
 *
 ...
 @param enabled TRUE = use accelerated reading, FALSE = use standard reading
