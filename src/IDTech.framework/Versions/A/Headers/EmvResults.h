...
@interface EmvResults : NSObject <NSXMLParserDelegate>
{
    NSString *status;
    NSString *result;
    NSString *ac;
    ...
    NSString *amount;
    NSString *tcc;
    NSString *tc_approved;
    NSString *aac_declined;
    NSString *aip;
...
@property (nonatomic, retain) NSString *tc_approved;
@property (nonatomic, retain) NSString *aac_declined;
...
@property (nonatomic, retain) NSString *tlv;
